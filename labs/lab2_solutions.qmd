...
*Answer: The Medici and Strozzi families appear to be the most important in this network.*
...
*Answer: The Medici family has both high degree centrality and high network centrality. This suggests that the Medici family is very powerful within this network.*
...
*Answer: If we drop the Medici family, this the network becomes much more fragmented (number of components increase). The most important family now appears to be the Guadagni family.*
...
*Answer: The Medici family has both bonding and bridging social capital. It has **bonding social capital** because it is well connected to several families in its immediate neighborhood, and has many direct ties. It also has **bridging social capital** because it has high **betweenness centrality**, meaning it lies on many of the shortest paths connecting different parts of the network. As a result, removing the Medici node would fragment the network into more components, showing that it connects otherwise separate groups of families.*
...
*Answer: The Medici family did not have the most wealth nor did it have the most priors (a measure of how many times they held office). If we just looked at these measures, we would assume it wasn't the most important family. This means they have both bridging and bonding social capital, allowing them to exert influence even though they were not the wealthiest or most politically dominant family by traditional measures.*
...
*Answer: This is likely due to students interacting and having lots of discussion partners with other people around their age (e.g., other students) and then having discussion partners with their parents (45-60).*
...
*Yes, we see strong evidence of gender homophily. People are much more likely to have discussion aprtners*
...
*Observed: (9 + 6) / (36 + 24 + 9 + 6) = 0.2*

*Expected (no homophily) = 2pq = 2 \* 0.5 \* 0.5 = 0.5*

*Because the observed proportion of cross-gender ties (0.20) is much lower than the expected proportion under random mixing (0.50), this provides clear evidence of **gender homophily**. Individuals form discussion ties with people of the same gender much more often than we would expect if partners were chosen randomly with respect to gender.*
...
*Answer: Approximately 73% of ties are between people of the same class year.*

```{r}
## test equivalency in R 
 responses %>% 
   filter(alter_classyear %in% c("Freshman", "Sophomore", "Junior", "Senior")) %>% 
   summarize(mean(alter_classyear == ego_classyear))
```
...
-   *Opportunity: students are more likely to have the opportunity to meet and become discussion partners with other students who are between the age of 18--25.*

-   *Selection: Students may prefer to become discussion partners with others of the same year, as they may share similar experiences, interests, and communication styles.*
...
*Answer: Restricting to discussion partners over the age of 40, both male and female respondents appear to report more **female** discussion partners than **male** discussion partners. However, the number of ties involving individuals over age 40 is small, so this pattern should be interpreted cautiously. One possible explanation is that older women may be more likely to serve as confidants or discussion partners in personal networks.*
