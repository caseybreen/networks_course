...
Each exercise will have 2-3 questions. Please complete these questions and upload the .qmd file to the corresponding lab assignment to Canvas to receive full credit for the lab.
...
You can find more information about details about how this dataset was generated from this paper:
...
`count(name = "")` counts the number of rows and assigns the number to "n_edges".
...
1.1 Discuss what you see from visualized network graph above. Does the Medici family appear central in the structure?

1.2 What does each centrality measure reveal about the Medici family's influence, and what does this imply about its power in the network?

1.3 What would happen if we remove Medici from the network? Run the code below and describe how the network has changed.
...
Now we'll turn to analyzing data from our homophily survey.
